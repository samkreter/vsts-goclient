...
func (a *PullRequestIterationStatusesApiService) Create(ctx context.Context, body GitPullRequestStatus, repositoryId string, pullRequestId int32, iterationId int32, project string, apiVersion string) (GitPullRequestStatus, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}/statuses"
...
func (a *PullRequestIterationStatusesApiService) Delete(ctx context.Context, repositoryId string, pullRequestId int32, iterationId int32, statusId int32, project string, apiVersion string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}/statuses/{statusId}"
	localVarPath = strings.Replace(localVarPath, "{"+"repositoryId"+"}", fmt.Sprintf("%v", repositoryId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pullRequestId"+"}", fmt.Sprintf("%v", pullRequestId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"iterationId"+"}", fmt.Sprintf("%v", iterationId), -1)
