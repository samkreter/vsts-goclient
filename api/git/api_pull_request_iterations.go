...
/*
PullRequestIterationsApiService
...
func (a *PullRequestIterationsApiService) Get(ctx context.Context, repositoryId string, pullRequestId int32, iterationId int32, project string, apiVersion string) (GitPullRequestIteration, *http.Response, error) {
	var (
		...
		localVarReturnValue GitPullRequestIteration
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}"
 ...
 * @param project Project ID or project name
 * @param apiVersion Version of the API to use.  This should be set to &#39;5.0-preview.1&#39; to use this version of the api.
 * @param optional nil or *ListPRIterationsOpts - Optional Parameters:
     * @param "IncludeCommits" (optional.Bool) -  If true, include the commits associated with each iteration in the response.

@return []GitPullRequestIteration
*/

type ListPRIterationsOpts struct {
...
func (a *PullRequestIterationsApiService) List(ctx context.Context, repositoryId string, pullRequestId int32, project string, apiVersion string, localVarOptionals *ListPRIterationsOpts) ([]GitPullRequestIteration, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations"
	localVarPath = strings.Replace(localVarPath, "{"+"repositoryId"+"}", fmt.Sprintf("%v", repositoryId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pullRequestId"+"}", fmt.Sprintf("%v", pullRequestId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
