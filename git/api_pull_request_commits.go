...
func (a *PullRequestCommitsApiService) GetPullRequestCommits(ctx context.Context, repositoryId string, pullRequestId int32, project string, apiVersion string) ([]GitCommitRef, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/commits"
...
func (a *PullRequestCommitsApiService) GetPullRequestIterationCommits(ctx context.Context, repositoryId string, pullRequestId int32, iterationId int32, project string, apiVersion string) ([]GitCommitRef, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}/commits"
	localVarPath = strings.Replace(localVarPath, "{"+"repositoryId"+"}", fmt.Sprintf("%v", repositoryId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pullRequestId"+"}", fmt.Sprintf("%v", pullRequestId), -1)
