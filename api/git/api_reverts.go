...
func (a *RevertsApiService) Create(ctx context.Context, body GitAsyncRefOperationParameters, project string, repositoryId string, apiVersion string) (GitRevert, *http.Response, error) {
	var (
		...
		localVarReturnValue GitRevert
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/reverts"
...
func (a *RevertsApiService) GetRevert(ctx context.Context, project string, revertId int32, repositoryId string, apiVersion string) (GitRevert, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{project}/_apis/git/repositories/{repositoryId}/reverts/{revertId}"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"revertId"+"}", fmt.Sprintf("%v", revertId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repositoryId"+"}", fmt.Sprintf("%v", repositoryId), -1)
